...
class YOLOv4ROSITR:
    def __init__(self):
        ...
        self.yolo_srv = rospy.Service('/detect_frame', YOLOLastFrame, self.yolo_service)    #the callback function for this service will only run when called
                                                                                              #naming the message /detect_frame from our own service that will get the last frame
