...
class StrToCoordNode:
    ...
    def service_cb(self, req):  #creates callback function. it will take a request
        ...
        if place in self.coordinates:
            ...
            response.coordinates.pose.position.x = self.coordinates[place][0]
            response.coordinates.pose.position.y = self.coordinates[place][1]
...
if __name__=="__main__":
    ...
    rospy.loginfo('this shit is running')
